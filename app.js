"use strict";
/* Data-Science quiz — vanilla JS. Loads window.QUESTIONS from questions.js. */

const QS = Array.isArray(window.QUESTIONS) ? window.QUESTIONS : [];
const HE_KEYS = ["א","ב","ג","ד","ה","ו","ז","ח"];
const STORE = "dsq_progress_v1";
...
function initStart(){
  ...
  $("#datasetInfo").textContent = `${QS.length} שאלות · מבחנים 2024–2026 + תרגול`;
}
